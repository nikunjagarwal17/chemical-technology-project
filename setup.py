...
print("🚀 Building PyroXa in Pure Python mode - Universal compatibility!")
...
setup(
    ...
    author_email='pyroxa@example.com',
    url='https://github.com/nikunjagarwal17/chemical-technology-project',
    python_requires='>=3.8',
    zip_safe=True,
